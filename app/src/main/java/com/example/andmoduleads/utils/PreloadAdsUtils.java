    ...
    public void setLayoutNative(int layoutNativeCustom){
        if (MyApplication.getApplication().getStorageCommon().nativeAdHigh != null){
            MyApplication.getApplication().getStorageCommon().apNativeAdHigh =
                    new ApNativeAd(layoutNativeCustom, MyApplication.getApplication().getStorageCommon().nativeAdHigh, BuildConfig.native_normal);
            ...
            MyApplication.getApplication().getStorageCommon().apNativeAdMedium =
                    new ApNativeAd(layoutNativeCustom, MyApplication.getApplication().getStorageCommon().nativeAdMedium, BuildConfig.native_normal);
            ...
            MyApplication.getApplication().getStorageCommon().apNativeAdNormal =
                    new ApNativeAd(layoutNativeCustom, MyApplication.getApplication().getStorageCommon().nativeAdNormal, BuildConfig.native_normal);
        }
    }
